...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Money added to your account</p>
        </div>
        
        <div class="content">
            <p>Hi <strong>{{ $recipient->full_name }}</strong>,</p>
            
            <p>Good news! You received a payment. Here are the details:</p>
            ...
            <div class="transaction-details">
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $sender->full_name }} ({{ $sender->email }})</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row" style="border-bottom: none; padding-top: 24px; margin-top: 16px; border-top: 2px solid #e7eaf0;">
                    ...
                    <span class="detail-value" style="font-size: 18px; font-weight: 700; color: #28a745;">{{ $newBalance }}</span>
                </div>
            </div>
            ...
            <p style="margin-top: 32px; font-size: 14px; color: #6c7378;">
                This payment has been added to your PayPal Secure balance.
            </p>
        </div>
